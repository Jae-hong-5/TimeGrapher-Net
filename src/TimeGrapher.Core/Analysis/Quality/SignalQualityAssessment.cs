...
///
/// Attached to the per-block detector snapshot as an annotation; it never
/// participates in the event-drop path. User-facing guidance text and
/// localisation live in the App layer, keyed off <see cref="Class"/>, so Core
