...
public sealed class WatchPositionsTests
{
    ...
    [InlineData(WatchPosition.P6H, "6H", "6 o'clock up", false, false)]
    [InlineData(WatchPosition.P9H, "9H", "9 o'clock up", false, false)]
    [InlineData(WatchPosition.P3H, "3H", "3 o'clock up", false, false)]
    [InlineData(WatchPosition.P12H, "12H", "12 o'clock up", false, false)]
