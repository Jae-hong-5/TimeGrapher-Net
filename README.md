...
- **Simple tests & CI** — `Core` has no UI/OS dependencies, so unit testing is easy (currently 655
...
**All 655 tests pass** under `dotnet test` (App 348 / Core 283 / WindowsAudio 11 / LinuxAudio 13).

```mermaid
pie showData
    title Test distribution (655 total)
    "App.Tests" : 348
    "Core.Tests" : 283
...
| Test | `dotnet test TimeGrapherNet.sln -c Release` (655/655) | ✅ |
