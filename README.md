...
- **Simple tests & CI** — `Core` has no UI/OS dependencies, so unit testing is easy (currently 471
...
**All 471 tests pass** under `dotnet test` (App 238 / Core 217 / WindowsAudio 6 / LinuxAudio 10).

```mermaid
pie showData
    title Test distribution (471 total)
    "App.Tests" : 238
    "Core.Tests" : 217
...
| Test | `dotnet test TimeGrapherNet.sln -c Release` (471/471) | ✅ |
