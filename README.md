...
- **Simple tests & CI** — `Core` has no UI/OS dependencies, so unit testing is easy (currently 657
...
**All 657 tests pass** under `dotnet test` (App 348 / Core 285 / WindowsAudio 11 / LinuxAudio 13).

```mermaid
pie showData
    title Test distribution (657 total)
    "App.Tests" : 348
    "Core.Tests" : 285
...
| Test | `dotnet test TimeGrapherNet.sln -c Release` (657/657) | ✅ |
