...
- **Simple tests & CI** — `Core` has no UI/OS dependencies, so unit testing is easy (currently 669
...
**All 669 tests pass** under `dotnet test` (App 359 / Core 286 / WindowsAudio 11 / LinuxAudio 13).

```mermaid
pie showData
    title Test distribution (669 total)
    "App.Tests" : 359
    "Core.Tests" : 286
...
| Test | `dotnet test TimeGrapherNet.sln -c Release` (669/669) | ✅ |
